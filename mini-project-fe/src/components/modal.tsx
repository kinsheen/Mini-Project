        ...
        <form onSubmit={handleSubmit}>
          <label className="block mb-2 font-medium">
            ...
            <input
              ...
              required
              className="block w-full border border-gray-300 rounded p-2 mt-1 font-medium"
            />
          </label>
          <label className="block mb-2 font-medium">
            Task:
            <textarea
              ...
              required
              className="block w-full border border-gray-300 rounded p-2 mt-1 h-32 resize-none font-medium" // Added height and disabled resizing
